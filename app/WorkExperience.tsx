...
function WorkExperience() {
  return (
    ...
    className='h-screen flex relative overflow-hidden flex-col text-lft md:flex-row max-w-full px-10 justify-evenly content-around mx-auto place-items-center'>
